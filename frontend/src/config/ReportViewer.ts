...
export const ReportViewer = {
  TITLE: msg`Reports`,
  AS_OF: msg`as of`,
  SECTION_DASHBOARDS: msg`Dashboards`,
  ...
  SELECT_PLACEHOLDER: msg`Select a look or a dashboard`,
  BADGE_REPORT: msg`report`,
  RELOAD_TITLE: msg`Reload Current Report`,
  RELOAD_BTN: msg`Reload`,
};
