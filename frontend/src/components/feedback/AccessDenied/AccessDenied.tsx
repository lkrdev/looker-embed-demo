...
export function AccessDenied({ title }: AccessDeniedProps) {
  ...
  return (
    <div className={styles.accessDeniedContainer}>
      <Card variant="glass" className={`${styles.accessDeniedCard} flex-col flex-center gap-5 text-center`}>
        <div className={`app-icon-container bg-error-light ${styles.accessDeniedIconWrap}`}>
