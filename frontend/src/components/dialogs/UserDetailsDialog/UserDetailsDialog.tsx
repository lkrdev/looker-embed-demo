...
export function UserDetailsDialog() {
  ...
  return (
    <div className="modal-overlay" onClick={handleClose}>
      <div
        className={`modal-container ${styles.userDetailsModal} ${isCollapsed ? 'collapsed' : ''}`}
      ...
      >
        ...
        {/* Modal Body */}
        <div className={`modal-body ${styles.userDetailsBody}`}>
          <div className={`json-container ${styles.userDetailsJsonWrapper}`}>
            <button
              onClick={handleCopy}
              className={`copy-btn ${styles.userDetailsCopyBtn}`}
